...
'response.write("Session(""ATTENDEE_LIST"") = " & Session("ATTENDEE_LIST"))
...
If sEXHIBITOR_ID = "" Then
	Response.Write("No badge payment activity for this exhibitor.")
Else
	...
	strSQL = strSQL & "isnull(l.amount_paid, 0) amount_paid, isnull(l.payment_type, '') payment_type, l.acttimestamp, isnull(e.addl_badges_non_comp, 0) addl_non_comp, isnull(e.addl_badges_comp, 0) addl_comp, l.tot_amount_due, isnull(l.initials, '') initials "
	strSQL = strSQL & "FROM log_badge_payment_activity l, exhibitor e "
	...
	Response.Write("<td width=100><div align=""center""><strong>Non Comp</strong></div></td>")
	'Response.Write("<td width=50><div align=""center""><strong>Comp</strong></div></td>")
	Response.Write("<td width=120><div align=""left""><strong>Payment Type</strong></div></td>")
	Response.Write("<td width=70><div align=""left""><strong>Initials</strong></div></td>")
	...
	Do While Not rsPaymentAct.EOF
		...
		Response.Write("<td width=100><div align=""center"">" & rsPaymentAct("addl_non_comp") & "</div></td>")
		'Response.Write("<td width=50><div align=""center"">" & rsPaymentAct("addl_comp") & "</div></td>")
		sPayType = ""
		...
		Response.Write("<td width=70><div align=""left"">" & rsPaymentAct("initials") & "</div></td>")
...
<title>The Registration Exhibitor Badge Payment Information</title>
<style type="text/css">
<!--
body,td,th {
...
<!--
<form name="attendee_payment_info" method=post action="registration.asp">
</form>
-->
