...
function IsItFive()
{
  ...
  // look for 5 numbers and then parse the xmldoc
	if (printform.ZIP.value.length == 5)
	{
    //alert("there are 5 ");
	//alert("the zip value is " + registration.ZIP.value);
	searchByZipcode(printform.ZIP.value);
	}
}
function searchByZipcode(zcode)
{
	...
	for (var i = 0; i < allZipcodes.length; i++)
	{
		...
		if (vNumber == zcode)
		{
			...
			printform.CITY.value = vCity;
			allStates = xmlDoc.getElementsByTagName("state");
			vState = allStates.item(i).firstChild.nodeValue;
			for (var j = 0; j < printform.STATES.options.length; j++)
			{
				if (printform.STATES.options[j].text == vState)
				{
					printform.STATES.selectedIndex = j;
					break;
				}
			}
			return;
...
//-->
	...
	<body >
		<form name="printform" method="post" action="manual_print_attendee_badge.asp">
			<table width="100%" border=0 cellspacing="0">
				<!--	<tr>
		<td colspan="2" align="center"><b>Manual Attendee Badge Print</b></td>
	</tr>
	<tr>
		<td colspan="2" align="center">&nbsp;</td>
	</tr>
	<tr>
		<td width="50%" align="right">First Name/Last Name</td>
		<td width="50%" align="left"><input type="text" name="NAME" size="50"></td>
	</tr>
	<tr>
		<td width="50%" align="right">Zip</td>
		<td width="50%" align="left"><input type="text" name="ZIP" size="25" ></td>
	</tr>
	<tr>
		<td width="50%" align="right">City</td>
		<td width="50%" align="left"><input type="text" name="CITY" size="50"></td>
	</tr>
	<tr>
		...
		<td width="50%" align="left">
              <select name="STATES">
                <option >&nbsp;</option>
                <option <% if STATES="AL" then response.write (" SELECTED ")%>>Alabama</option>
                <option <% if STATES="AK" then response.write (" SELECTED ")%>>Alaska</option>
                <option <% if STATES="AB" then response.write (" SELECTED ")%>>Alberta</option>
                <option <% if STATES="AZ" then response.write (" SELECTED ")%>>Arizona</option>
                <option <% if STATES="AR" then response.write (" SELECTED ")%>>Arkansas</option>
                <option <% if STATES="BC" then response.write (" SELECTED ")%>>British Columbia</option>
                <option <% if STATES="CA" then response.write (" SELECTED ")%>>California</option>
                <option <% if STATES="CO" then response.write (" SELECTED ")%>>Colorado</option>
                <option <% if STATES="CT" then response.write (" SELECTED ")%>>Connecticut</option>
                <option <% if STATES="DE" then response.write (" SELECTED ")%>>Delaware</option>
                <option <% if STATES="FL" then response.write (" SELECTED ")%>>Florida</option>
                <option <% if STATES="GA" then response.write (" SELECTED ")%>>Georgia</option>
                <option <% if STATES="HI" then response.write (" SELECTED ")%>>Hawaii</option>
                <option <% if STATES="ID" then response.write (" SELECTED ")%>>Idaho</option>
                <option <% if STATES="IL" then response.write (" SELECTED ")%>>Illinois</option>
                <option <% if STATES="IN" then response.write (" SELECTED ")%>>Indiana</option>
                <option <% if STATES="IA" then response.write (" SELECTED ")%>>Iowa</option>
                <option <% if STATES="KS" then response.write (" SELECTED ")%>>Kansas</option>
                <option <% if STATES="KY" then response.write (" SELECTED ")%>>Kentucky</option>
                <option <% if STATES="LA" then response.write (" SELECTED ")%>>Louisiana</option>
                <option <% if STATES="ME" then response.write (" SELECTED ")%>>Maine</option>
                <option <% if STATES="MB" then response.write (" SELECTED ")%>>Manitoba</option>
                <option <% if STATES="MD" then response.write (" SELECTED ")%>>Maryland</option>
                <option <% if STATES="MA" then response.write (" SELECTED ")%>>Massachusetts</option>
                <option <% if STATES="MI" then response.write (" SELECTED ")%>>Michigan</option>
                <option <% if STATES="MN" then response.write (" SELECTED ")%>>Minnesota</option>
                <option <% if STATES="MS" then response.write (" SELECTED ")%>>Mississippi</option>
                <option <% if STATES="MO" then response.write (" SELECTED ")%>>Missouri</option>
                <option <% if STATES="MT" then response.write (" SELECTED ")%>>Montana</option>
                <option <% if STATES="NE" then response.write (" SELECTED ")%>>Nebraska</option>
                <option <% if STATES="NV" then response.write (" SELECTED ")%>>Nevada</option>
                <option <% if STATES="NB" then response.write (" SELECTED ")%>>New Brunswick</option>
                <option <% if STATES="NH" then response.write (" SELECTED ")%>>New Hampshire</option>
                <option <% if STATES="NJ" then response.write (" SELECTED ")%>>New Jersey</option>
                <option <% if STATES="NM" then response.write (" SELECTED ")%>>New Mexico</option>
                <option <% if STATES="NSW" then response.write (" SELECTED ")%>>New South Wales</option>
                <option <% if STATES="NY" then response.write (" SELECTED ")%>>New York</option>
                <option <% if STATES="NL" then response.write (" SELECTED ")%>>Newfoundland</option>
                <option <% if STATES="NC" then response.write (" SELECTED ")%>>North Carolina</option>
                <option <% if STATES="ND" then response.write (" SELECTED ")%>>North Dakota</option>
                <option <% if STATES="NT" then response.write (" SELECTED ")%>>Northern Territory</option>
                <option <% if STATES="NT" then response.write (" SELECTED ")%>>Northwest Territories</option>
                <option <% if STATES="NS" then response.write (" SELECTED ")%>>Nova Scotia</option>
                <option <% if STATES="NU" then response.write (" SELECTED ")%>>Nunavut</option>
                <option <% if STATES="OH" then response.write (" SELECTED ")%>>Ohio</option>
                <option <% if STATES="OK" then response.write (" SELECTED ")%>>Oklahoma</option>
                <option <% if STATES="ON" then response.write (" SELECTED ")%>>Ontario</option>
                <option <% if STATES="OR" then response.write (" SELECTED ")%>>Oregon</option>
                <option <% if STATES="PA" then response.write (" SELECTED ")%>>Pennsylvania</option>
                <option <% if STATES="PE" then response.write (" SELECTED ")%>>Prince Edward Island</option>
                <option <% if STATES="QC" then response.write (" SELECTED ") %>>Quebec</option>
                <option <% if STATES="QLD" then response.write (" SELECTED ")%>>Queensland</option>
                <option <% if STATES="RI" then response.write (" SELECTED ")%>>Rhode Island</option>
                <option <% if STATES="SK" then response.write (" SELECTED ")%>>Saskatchewan</option>
                <option <% if STATES="SA" then response.write (" SELECTED ")%>>South Australia</option>
                <option <% if STATES="SC" then response.write (" SELECTED ")%>>South Carolina</option>
                <option <% if STATES="SD" then response.write (" SELECTED ")%>>South Dakota</option>
                <option <% if STATES="TAS" then response.write (" SELECTED ")%>>Tasmania</option>
                <option <% if STATES="TE" then response.write (" SELECTED ")%>>Tennessee</option>
                <option <% if STATES="TX" then response.write (" SELECTED ")%>>Texas</option>
                <option <% if STATES="UT" then response.write (" SELECTED ")%>>Utah</option>
                <option <% if STATES="VT" then response.write (" SELECTED ")%>>Vermont</option>
                <option <% if STATES="VIC" then response.write (" SELECTED ")%>>Victoria</option>
                <option <% if STATES="VA" then response.write (" SELECTED ")%>>Virginia</option>
                <option <% if STATES="WA" then response.write (" SELECTED ")%>>Washington</option>
                <option <% if STATES="DC" then response.write (" SELECTED ")%>>Washington DC</option>
                <option <% if STATES="WV" then response.write (" SELECTED ")%>>West Virginia</option>
                <option <% if STATES="W AUST" then response.write (" SELECTED ")%>>Western Australia</option>
                <option <% if STATES="WI" then response.write (" SELECTED ")%>>Wisconsin</option>
                <option <% if STATES="WY" then response.write (" SELECTED ")%>>Wyoming</option>
                <option <% if STATES="YT" then response.write (" SELECTED ")%>>Yukon Territory</option>
              </select>
		</td>
	</tr>
	<tr>
			  ...
			  <select name="COUNTRY" >
				...
				<tr>
					...
					<td colspan=3 width=85%>
						<input type="text" value="" name="NAME" size=125 maxlength=50>
					</td>
				</tr>
				<tr>
					<td width=15%>
					...
					<td colspan=3 width=85%>
						<input type="text" value="" name="SCHOOL_COMPANY" size=125 maxlength=125>
					</td>
				</tr>
				<tr>
					<td width=15%>
					...
					<td colspan=3 width=85%>
						<input type=text value="" name="ADDRESS" size=125 maxlength=125>
					</td>
				</tr>
				<tr>
					...
					<td width=35%>
						<input value="" type=text name="CITY" size=50 maxlength=50>
					</td>
					<td width=15%>
						<div align="right">
				...
				<tr>
					...
					<td width=35%>
						<input type="text" value="" name="ZIP" size=15 >
					</td>
				</tr>
				<tr>
					<td width=15%>
				...
				<tr>
					...
					<td width="50%" align="left">
						<select name="BADGETYPE" onChange="DisplayAmountDue(this.value)">
							<option>
								&nbsp;
							</option>
<option <% if BADGETYPE="BOARD SPOUSE" then response.write (" SELECTED ")%>>
								BOARD SPOUSE
							</option>

							<option <% if BADGETYPE="DIRECTOR/ADULT" then response.write (" SELECTED ")%>>
								DIRECTOR/ADULT
							</option>
							<option <% if BADGETYPE="COMMERCIAL" then response.write (" SELECTED ")%>>
								COMMERCIAL
							</option>
							<option <% if BADGETYPE="GUEST" then response.write (" SELECTED ")%>>
								GUEST
							</option>
							<option <% if BADGETYPE="COLLEGE STUDENT" then response.write (" SELECTED ")%>>
								COLLEGE STUDENT
							</option>
							<option <% if BADGETYPE="CLINICIAN" then response.write (" SELECTED ")%>>
								CLINICIAN
							</option>
							<option <% if BADGETYPE="STAFF" then response.write (" SELECTED ")%>>
								STAFF
							</option>
						</select>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left">
						<select name="PREREG">
							...
							<option <% if PREREG="Yes" then response.write (" SELECTED ")%>>
								Yes
							</option>
							<option <% if PREREG="No" then response.write (" SELECTED ")%>>
								No
							</option>
						</select>
					</td>
